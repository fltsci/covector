    ...
    if (process.platform !== "win32") {
      describe("cargo through curl", () => {
        it("already published", function* () {
            ...
            commands: [
              {
                ...
                getPublishedVersion:
                  "curl -sA 'covector-test (https://github.com/fltsci/covector)' https://crates.io/api/v1/crates/tauri/0.11.0 | if grep -q '\"errors\"'; then echo not found; else echo 0.11.0; fi;",
              },
            ],
            cwd: "",
            command: "publish",
          ...
          yield pinoTest.consecutive(stream, [
            {
              msg: "Checking if tauri@0.11.0 is already published with: curl -sA 'covector-test (https://github.com/fltsci/covector)' https://crates.io/api/v1/crates/tauri/0.11.0 | if grep -q '\"errors\"'; then echo not found; else echo 0.11.0; fi;",
              level: 30,
            },
            {
              msg: "0.11.0",
        ...
        it("needs publish", function* () {
            ...
            commands: [
              {
                ...
                getPublishedVersion:
                  "curl -sA 'covector-test (https://github.com/fltsci/covector)' https://crates.io/api/v1/crates/tauri/0.12.0 | if grep -q '\"errors\"'; then echo not found; else echo 0.12.0; fi;",
              },
            ],
            cwd: "",
            command: "publish",
          ...
          yield pinoTest.consecutive(stream, [
            {
              msg: "Checking if tauri@0.12.0 is already published with: curl -sA 'covector-test (https://github.com/fltsci/covector)' https://crates.io/api/v1/crates/tauri/0.12.0 | if grep -q '\"errors\"'; then echo not found; else echo 0.12.0; fi;",
              level: 30,
            },
            {
              msg: "not found",
